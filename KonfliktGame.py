...
def DamageCheck():
    if (Character["Weapon"] == "Sword"):
        Stats["DMG"] = 2+4+power/0.5
    if (Character["Weapon"] == "Spear"):
        Stats["DMG"] = 2+8+power/0.9
